...
<template>
    <h2 class="text-xl lg:text-2xl  dark:text-gray-200 cursor-pointer font-bold mb-6 ml-6 lg:ml-10 xl:ml-20 mt-6 lg:mt-10 "><span class="text-slate-900 dark:text-white">{{ headline }}</span></h2>
