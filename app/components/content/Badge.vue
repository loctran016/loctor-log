<template>
<section class="pt-6 pb-2 px-4 lg:px-6 border-l-4 dark:prose-li:marker:text-gray-50/30 prose-li:marker:text-gray-900/20" :class="containerTypes[type].containerClass">
...
const containerTypes = {
    info: {
        containerClass: 'bg-emerald-400/10 border-l-green-300/50',
        headerClass: 'text-green-800 dark:text-green-500',
        headerIcon: 'material-symbols-light:info-outline-rounded',
    },
    warning: {
        containerClass: 'bg-amber-400/10 border-l-amber-300/50',
        headerClass: 'text-orange-600 dark:text-orange-400',
        headerIcon: 'material-symbols-light:warning-outline-rounded',
    },
    tip: {
        containerClass: 'bg-violet-400/10 border-l-violet-300/50',
        headerClass: 'text-violet-600 dark:text-violet-400',
        headerIcon: 'material-symbols-light:rocket-launch-outline-rounded',
    },
    quiz: {
        containerClass: 'bg-sky-400/10 border-l-sky-300/50',
...
const props = defineProps({
  type: {
    type: String,
    default: 'info',
    validator: (value) => ['info', 'warning','quiz','tip'].includes(value),
  }
});
</script>
