---
title: Bài 4a - Cơ chế bù trừ trong suy tim
date: 2025-11-19
tags: ['Sinh lý']
---
...
- Bù trừ bằng: =a=tăng thể thể tích tâm trương== bất thường

## Nguyên nhân suy tim

Nguyên nhân nguyên phát:

- =r=Thiếu máu cơ tim== gây ra bệnh mạch vành là nguyên nhân phổ biến nhất
- Nhồi máu cơ tim
- Cơ tim phì đại
- Cơ tim dãn nở
- Cơ tim hạn chế
...
- Trong đó =r=tăng HA== thường gặp nhất, hiện đang trẻ hoá
...
1. Nghẽn ĐM phổi: BN bất động kéo dài -> Huyết khối TM chi dưới/chậu -> nghẽn ĐM phổi -> suy tim, nhồi máu phổi
2. Viêm màng trong tim nhiễm khuẩn: Gây sốt, thiếu máu, tổn thương van tim, viêm cơ tim
3. Nhiễm độc giáp và thai nghén: tăng lưu lượng tim
4. Nhồi máu cơ tim: giảm chức năng tâm thất
...
1. Áp suất tâm thất trái cưới tâm trương tăng -> AS tâm nhĩ trái tăng -> AS TM phổi tăng -> AS mao mạch phổi tăng -> sung huyết phổi
2. Phù phổi cấp: ASTT mao mạch phổi > AS keo -> HT, hồng cầu thoát vào phế nang -> =r=khó thở do phế nang bị ứ dịch==
...
2. Giảm bài tiết nước tiểu: Máu đến thận giảm nên giảm độ lọc cầu thận.
3. Phù:

- Tim giảm chức năng bơm máu -> lưu lượng máu đến thận giảm -> thận tái hấp thu muối, nước -> Tăng áp suất thủy tĩnh (cơ chế chính)
- Thiếu O<sub>2</sub> -> TB nội mô mạch máu co lại -> tăng tính thấm thành mạch.
...
1. Tổn thương TB cơ tim → mất dần chức năng co bóp
...
Phụ thuộc:
✓ AL độ đầy thất: Máu TM về tâm thất
✓ Độ dãn tâm thất
✓ Sức co bóp cơ tim
...
Định luật Starling: mối tương quan giữa thể tích/áp lực cuối tâm trương trong tâm thất với thể tích nhát bóp
Khi áp lực/thể tích cuối tâm trương trong tâm thất tăng lên sẽ làm tăng sức co bóp cơ tim và thể tích nhát bóp
...
Trong suy tim, lúc đầu nhịp tim tăng lên để bù trừ cho giảm thể tích nhát bóp → duy trì CLT
  CLT = TS tim x V nhát bóp

Nếu nhịp tim tăng quá mức → thời gian tâm trương ngắn lại → giảm V cuối tâm trương của tâm thất → V nhát bóp giảm
  → tăng công và oxy tiêu thụ → suy tim nhanh chóng
...
Tâm thất dãn ra sẽ kéo dài các sợi cơ tim
-> Theo định luật Starling: tăng sức co bóp cơ tim
...
- Khi suy tim, hệ thần kinh giao cảm bị kích thích
→ catecholamin tiết ra → tăng sức co bóp cơ tim và tần số tim
...
Trong suy tim =a=giai đoạn muộn==, vùng hạ đồi – tuyến yên được kích thích tiết ra Arginin – Vasopressin
