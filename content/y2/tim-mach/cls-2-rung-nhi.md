...
- Khó thở: suy tim trái → ứ máu thất T → ứ nhĩ T -> ứ 4 TMP → ứ mao mạch phổi → =c=dịch từ mao mạch thoát vào mô kẽ phổi và phế nang== → khó thở
...
- QRS k đều do k cùng chủ nhịp, mỗi ổ nhịp phát nhịp một kiểu → rất đa dạng → có cái khử cực thất, có cái
đáp ứng thất k đều, đáp ứng thất khoảng 110 => Đây là rung nhĩ đáp ứng thất nhanh
- V1, V2, V3 sóng R cụt do sóng R là sóng R là sóng khử cực thành trước thất trái mà giờ bị cụt tức là cơ tim k
có (BN NMCT – tức là chết cơ tim) → R cụt
...
Rung nhĩ: cơ nhĩ co bất thường → hút máu về và đẩy máu đi bất thường → pha nhĩ thu cuối tâm trương tuy chỉ chiếm ¼ thể tích nhưng lại kèm theo đáp ứng thất nhanh → thời gian tâm trương
của thất bị ngắn lại → giai đoạn tim hút máu về nhanh thì tâm trương bị ngắn lại, tuy gđ này hút đc 70% Vmáu nhưng tâm trương ngắn → hút ↓ đi nhiều và nhĩ đẩy xuống ít → ứ máu tại nhĩ

Tần số thất nhanh mà BN này có bệnh TMCB → ↑ nhu cầu O2 → tim đập nhanh → mất cân bằng → ảnh
hưởng co bóp cơ tim
...
Ngoài hệ RAA và hệ GC đáp ứng bù trừ của cơ thể (có hại), hệ NT-proBNP đảo ngược tác dụng 2 hệ trên,
thả muối nước, giãn mạch, đảo ngược tái cấu trúc → có lợi
...
Rung nhĩ hình thành máu đông -> =c=tắc ở não, phổi, TM ngoại biên, ĐM ngoại biên==.
...
=> Đối với rung nhĩ, =a=đột quỵ liên quan ĐM não rất hay gặp==, những hệ thống ĐM khác bên trái, phổi rất hiếm.
...
- Nếu dùng thuốc làm ↑ sức co bóp cơ tim như
adrenaline, doputamine… k đc vì nó ↑ co và ↑ tần số tim → ↑ là ngủm.
- Digoxin làm chậm đáp ứng thất, ↓ dẫn truyền nút nhĩ thất (chặn đáp ứng thất nhanh).
K dùng thuốc chẹn β do nó làm ức chế co bóp cơ tim → suy tim sung huyết CCĐ chẹn β
...
- Acenocoumarol kháng vit K (II, VII, IX, X) → Ăn gì nhiều vit K thì thuốc acenocoumarol vô ích vì nó đối kháng vit K → có lợi nhưng tương tác thuốc nhiều → hạn chế
→ Lần 2 khám thì dùng thuốc kháng động thế hệ mới, kháng đông trực tiếp Ribandoxavan (uống) ƯC tương tự heparin: ƯC Xa → kiểm soát hoạt tính thuốc tốt, k tương tác thức ăn.

## Câu 7: Thuốc tác động lên thần kinh-thể dịch dựa trên cơ chế bệnh sinh của suy tim

- Lisinopril: ƯCMC angioI thành angioII (co mạch, giữ muối nước, ↑ HA) → tác động lên cơ chế sinh lí bệnh
suy tim
- Bisoprolol: chẹn β (nãy nói k dùng mà sao h dùng?) do lúc đầu BN sống nhờ hệ GC, sức co bóp cơ tim đang
cần bù trừ mà dùng chẹn β lúc đó thì chết; sau khi sd những thuốc giúp cân bằng tiền tải, hậu tải, sức co bóp
co tim (digoxin, TLT, Lisinopril) → tim ổn định → đưa thuốc đảo ngược TK – thể dịch: thụ thể β trong cơ
tim (hệ dẫn truyền) β1 β2.
Khi suy tim, dòng GC ra nhiều → kích thích β ↑ co bóp, ↑ nhịp tim, ↑ tần số tim,
về lâu dài thụ thể β ↓ số lượng, k còn cái j bù trừ → chẹn β lại, khi cần sẽ có cải thiện xung GC lên cơ tim
- Spironolactone: TLT đối vận aldosterone (aldosterone gây xơ hóa, giữ muối nước, chết tb)
- Valsartan: chẹn thụ thể angioII; ngăn hđ angioII
- Sacubitril: hệ NP có lợi nhưng tồn tại trong cơ thể ngắn do có men chuyển NP đi, sacubitril là thuốc ức chế men đó.
Tại sao đặt sten
