...
- Giảm tiểu cầu nặng: < 20.000/mm<sup>3</sup>
- Đời sống: 7 – 10 ngày
...
- Tỉ lệ Albumin/Globulin approx. 1 - 1.5 -> tỉ lệ chức năng gan/hệ MD
...
Chuyển hoá: Chu trình =a=Embden-Meyerhof yếm khí==, enzyme quan trọng là =v=pyruvat kinase==
...
- Erythropoitein - glycoprotein (tạo từ REF - thân): =r=quan trọng nhất==

### Hemoglobin

Hb tăng ái lực với O<sub>2</sub> khi (H<sup>+</sup> giảm - nghịch với pH tăng):

- pH tăng (H<sup>+</sup> giảm)
- CO<sup>2</sup> giảm
- Nhiệt độ giảm
- 2,3-DPG giảm

Trẻ > 6 tháng tuổi đã đổi thay gần hết HbF (alpha<sub>2</sub>delta<sub>2</sub>) thành HbA (alpha<sub>2</sub>beta<sub>2</sub>)

Mỗi phân tử Hb gồm 4 nhân heme (vòng porphyrin + Fe<sup>2+</sup>) + 4 chuỗi globin
...
- Đau xương ức, khó thở, bồn chồn, tụt huyết áp,
→ là biểu hiện phản ứng tan máu cấp do truyền nhầm nhóm máu ABO.
...
Do hệ thống MD tấn công vào TC NGOẠI VI.
Xét nghiệm:
...
- Tủy đồ: **Bình thường**.
Loại trừ các bệnh lý tủy xương khác.
