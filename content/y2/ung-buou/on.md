...
Tia UV: chuyển =r=urocanic acid (UCA) từ trans -> cis==
...
- <u>Tế bào NK:</u> Tăng biểu hiện MHC-I và giảm biểu hiện stress-cel
- <u>ĐTB:</u>
  - CRT (già rồi)
...
=c=Hiệu chỉnh MD== (của bướu) *tăng dần* v/s =c=Giám sát MD== (cơ thể) *giảm dần*: Thải loại -> Cân bằng -> Đào thoát
...
Các TB ung thư ức chế sự hoạt hoá =r=procaspase 3== -> ứ đọng procaspase 3 (nhất là ung thư =r=đại tràng==)
